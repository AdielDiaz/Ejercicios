<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consultas2.aspx.cs" Inherits="Parcial_III_ProgramciónComputacional.Consultas2" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="GVConsultar2" runat="server"  AutoGenerateColumns="False"  >
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Carreo" DataField="Correo"/>
