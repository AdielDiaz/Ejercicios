<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modificar.aspx.cs" Inherits="Parcial_III_ProgramciónComputacional.Modificar" %>
 ...
 <ul class="nav-links"> 
  ...
  <br><br><br>
   ...
   <br>
    ...
    Carrera:
    <asp:TextBox id="carreramod" Text="" runat="server" />
    <br /><br />

    Correo:
    <asp:TextBox id="correomod" Text="" runat="server" />
    <br /><br />

    Teléfono:
    <asp:TextBox id="telefonomod" Text="" runat="server" />
    <br /><br />
